...
<body>
    ...
    <div class="sidebar">
        <h4>Dashboard GPM</h4>
        <a href="#rekapLaporan">Rekap Laporan</a>
        <a href="#rps">Data RPS</a>
        <a href="#unsurRps">Unsur RPS</a>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <h2>Dashboard GPM</h2>
            <p>Selamat datang di dashboard Gugus Penjaminan Mutu</p>
        </div>
        ...
        <div id="unsurRps" class="container section">
            <h4>Unsur RPS</h4>
            <p>Daftar unsur-unsur yang harus ada dalam RPS.</p>
