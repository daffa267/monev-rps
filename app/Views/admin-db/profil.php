...
<body>
    <div class="dashboard-container">
        <nav class="sidebar">
            ...
            <div class="menu-item">
                <i class=""></i> <a href="<?= base_url('/'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
        ...
        <div class="main-content">
            <header class="main-header">
                <h1 class="h4"><a href="<?= base_url('admin'); ?>">Home</a> / Profil</h1>
            </header>

            <div class="profile-container">
                <div class="profile-content">
                    <form action="<?= base_url('profil/update') ?>" method="POST" class="profile-form">
                        <?= csrf_field() ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nidn" name="nidn" value="<?= user()->nidn ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="fakultas" name="fakultas" value="<?= user()->fakultas ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="jurusan">Jurusan:</label>
                            <input type="text" id="jurusan" name="jurusan" value="<?= user()->jurusan ?>" readonly>
                        </div>
                        ...
                        <button type="submit" class="btn btn-success" id="saveButton" style="display: none;">Simpan</button>
                    </form>

                    <div class="profile-image">
                        <img src="<?= base_url('img/admin.png'); ?>" alt="Profile Picture">
                        <button type="button" class="btn btn-secondary mt-2" id="changePhotoButton">Ganti Foto</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.getElementById('editButton').addEventListener('click', function() {
            // Enable all input fields except role
            const inputs = document.querySelectorAll('.profile-form input:not([name="role"])');
        ...
        document.getElementById('changePhotoButton').addEventListener('click', function() {
            ...
            alert('Fitur ganti foto akan segera tersedia');
        });
    </script>
